 ...
 * @author Brooks Walsh
 * @HW3_additions Implemented Closeable interface in the Bank class which allows
 *                for a new menu option: "manageCloseables". To keep the main
 *                method clean, it is separated into its own method. Other small
 *                changes have been made like an additional input validation
 *                method and a small change to the way sorting accounts work
 *                (now only by balance).
 */
