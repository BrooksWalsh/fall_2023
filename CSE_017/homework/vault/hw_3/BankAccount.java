...
public abstract class BankAccount implements Comparable<BankAccount>, Closeable {
    ...
    // ---------------------------------------
    // Start of added material for Homework 3
    // ---------------------------------------

    /**
     * Implements compareTo method to compare the balance of two BankAccount objects
     * 
     * @param ba
     * @return 0 if the balances are equal, positive if "this" BankAccount has a
     *         higher balance, negative if argument has higher balance.
     */
     ...
     * BankAccount objects.
     * 
     * @return true if balance of BankAccount object is less than 200, else false.
     */
    ...
    // ---------------------------------------
    // End of added material for Homework 3
    // ---------------------------------------
}
